...
namespace TaxiApp
{
    ...
    public sealed partial class SocketPage : Page
    {
        ...
        /// </summary>
        public DataModel.SocketModel DefaultViewModel
        {
        ...
        private void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            //TaxiApp.Core.SocketClient client = new Core.SocketClient();

            SocketClient.ConnectAsync(defaultViewModel.Host, defaultViewModel.Port).ContinueWith(t =>
                {
                    string res = "ok";

                    TaxiApp.Core.Socket.SocketManager socketMG = new Core.Socket.SocketManager(SocketClient);
